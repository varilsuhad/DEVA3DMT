...
for i=1:nf
    ...
    if(set.SPpreconditioning==1)
        ...
        [xx,r,relres]=gpbicgmexP2FFsi(PC.rowA,PC.colA,PC.valA,complex(b12),PC.rowM,PC.colM,(PC.valM),set.limDigerGN*ek,set.maxit,set.stagdetect,complex(PC.xJT{i}));
        else
        [xx,r,relres]=gpbicgmexP2FFsS(PC.rowA,PC.colA,PC.valA,complex(b12),PC.rowM,PC.colM,(PC.valM),set.limDigerGN*ek,set.maxit,set.stagdetect,complex(PC.xJT{i}));
        end
    else
        if(set.MatrixStacking==1)
        [xx,r,relres]=gpbicgmexP2FFdi(PC.rowA,PC.colA,PC.valA,complex(b12),PC.rowM,PC.colM,(PC.valM),set.limDigerGN*ek,set.maxit,set.stagdetect,complex(PC.xJT{i}));
        else
        [xx,r,relres]=gpbicgmexP2FFsD(PC.rowA,PC.colA,PC.valA,complex(b12),PC.rowM,PC.colM,(PC.valM),set.limDigerGN*ek,set.maxit,set.stagdetect,complex(PC.xJT{i}));
        end
    end
    ...
    if(relres>set.limDigerGN*ek)
        ...
        if(set.MatrixStacking==1)
        [xx2,r2,relres2]=gpbicgmexP2FFdi(PC.rowA,PC.colA,PC.valA,complex(b12),PC.rowM,PC.colM,PC.valM,set.limDigerGN*ek,set.maxit,set.stagdetect,complex(PC.xJT{i}));
        else
        [xx2,r2,relres2]=gpbicgmexP2FFsD(PC.rowA,PC.colA,PC.valA,complex(b12),PC.rowM,PC.colM,PC.valM,set.limDigerGN*ek,set.maxit,set.stagdetect,complex(PC.xJT{i}));
        end
        if(relres2<relres)
